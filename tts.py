...
def read_paper(ID,folder='.'):
   ...
   if os.path.isdir(fname):
      ...
      if not os.path.isfile(xml_file):
         ...
         os.system(com)
         if not os.path.isfile(xml_file):
            read_text(f'Sorry, I couldnt parse the tex file in {folder}')
      read_text(text.read_tex(xml_file))
